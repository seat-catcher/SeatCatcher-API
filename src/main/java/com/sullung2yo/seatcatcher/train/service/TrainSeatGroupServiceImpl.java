...
public class TrainSeatGroupServiceImpl implements TrainSeatGroupService {
    ...
    public TrainSeatGroupServiceImpl(TrainSeatGroupRepository trainSeatGroupRepository, TrainSeatRepository trainSeatRepository) {
        this.trainSeatGroupRepository = trainSeatGroupRepository;
    ...
    public TrainSeatGroup create(TrainCar car, SeatGroupType groupType){
        ...
        TrainSeatGroup trainSeatGroup = new TrainSeatGroup(
                car,
                new ArrayList<>(),
                groupType
        );
